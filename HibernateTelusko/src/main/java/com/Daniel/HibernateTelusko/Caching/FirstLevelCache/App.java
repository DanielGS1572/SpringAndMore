...
///******Para obtener valores de la base de datos******/
       ...
       telusko2 = (Alien) session2.get(Alien.class, 101);			/*Ver en el log que en este punto ya no hace un segundo select, pues ya esta en el first level cache (teniendo un solo sesion (comentanod las dos lineas anteriores*/
       System.out.println(telusko);
       session2.close();
