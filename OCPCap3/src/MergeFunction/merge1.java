...
public class merge1 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println();
		/*si el mapping function regresa nulo, vuela el elemento de la lista, el siguiente ejemplo se vuela todo lo que sí este en la lista
		...
		lista2.merge("Sam", "SkyRide", mapper2);
